...
<script type="text/javascript">
  function reply_ajax(){
	  alert("테스트");
	  alert("비밀번호 : " + $("#replyPw").val());
	  alert("내용 : " + $("#replyContent").val());
	  ...
	  $.ajax({
		 ...
		 success:function(data){
			 alert("data "+data.replyCount);
			 var html="";
			 var id = "${session_id}";
			 // 댓글의 번호를 통해 데이터 수정,삭제를 하기 위해
			 html = html + "<ul id='"+data.replyVo.replynum+"'>";
			...
			<div id="contents">
				<div id="mypage">
					...
					<div class="replyWrite">
						<ul>
							<li class="in">
								<p class="txt">총 <span id="replyCount" class="orange">2</span> 개의 댓글이 달려있습니다.</p>
