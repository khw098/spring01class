...
<section>
    ...
    <table>
      ...
      <tr>
        <th colspan="3">제목<span class="separator">|</span> ${mvc_board.btitle }</th>
      </tr>
      <tr>
        <td colspan="3"><strong>작성일</strong><span class="separator">|</span> ${mvc_board.bdate }</td>
      </tr>
      <tr>
        <td><strong>작성자</strong><span class="separator">|</span> ${mvc_board.userid }</td>
        <td><strong>조회수</strong></td>
        <td>${mvc_board.bhit }</td>
      </tr>
      <tr>
        <td colspan="3" class="article">${mvc_board.bcontent }</td>
      </tr>
      <tr>
